...
Everything below is a shell command you run yourself. This skill needs `awal`, `npm`, `curl`, `jq`, `tar`, `python3` on your
...
signature is produced inside awal, which already holds the key; this skill only hands
